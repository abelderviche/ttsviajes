const RESOURCES = {
  BRANCHES: 'Sucursales',
  PHONE: '0810-345-0887',
  PHONE_SALES: 'Venta telefónica',
  CONTACT_TIMES: 'Lun a Vie 9 a 19hs. Sáb y Dom 10 a 15hs',
  FLIGHTS: 'Vuelos',
  HOTELS: 'Hoteles',
  PACKAGES: 'Paquetes',
  CARS: 'Autos',
  ...
  SEARCH_BOX: {
    ...
    DEPARTURE: 'Ida',
    RETURNING: 'Vuelta',
    TRAVELLING_TO: 'Ingresá hacia donde viajás',
    TRAVELLING_FROM: 'Ingresá desde donde viajás',
    // Hotels
